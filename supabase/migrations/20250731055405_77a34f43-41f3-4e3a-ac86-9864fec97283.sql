-- Primeiro criar alguns perfis de usuário para as clínicas (usando 'clinic' ao invés de 'clinic_owner')
INSERT INTO public.profiles (id, user_id, email, full_name, role, phone) VALUES
(gen_random_uuid(), gen_random_uuid(), 'admin@odontosaude.com.br', 'Dr. João Silva', 'clinic', '(11) 98765-4321'),
(gen_random_uuid(), gen_random_uuid(), 'admin@sorrisoperfeito.com.br', 'Dra. Maria Santos', 'clinic', '(21) 98765-4321'),
(gen_random_uuid(), gen_random_uuid(), 'admin@dentalcare.com.br', 'Dr. Carlos Oliveira', 'clinic', '(31) 98765-4321'),
(gen_random_uuid(), gen_random_uuid(), 'admin@dentalmoderna.com.br', 'Dra. Ana Costa', 'clinic', '(51) 98765-4321'),
(gen_random_uuid(), gen_random_uuid(), 'admin@odontoexcellence.com.br', 'Dr. Pedro Lima', 'clinic', '(81) 98765-4321');
