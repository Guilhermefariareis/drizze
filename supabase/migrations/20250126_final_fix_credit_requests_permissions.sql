...
-- Keep the clinic_id foreign key as it's safe and necessary
-- ALTER TABLE credit_requests DROP CONSTRAINT IF EXISTS credit_requests_clinic_id_fkey;
-- ALTER TABLE credit_requests ADD CONSTRAINT credit_requests_clinic_id_fkey 
...
COMMENT ON TABLE credit_requests IS 'Tabela de solicitações de crédito - foreign key patient_id removida para corrigir permission denied - 2025-01-26';