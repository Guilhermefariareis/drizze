-- Migração para corrigir políticas RLS da tabela credit_requests
...
COMMENT ON TABLE credit_requests IS 'Tabela de solicitações de crédito - RLS simplificado sem