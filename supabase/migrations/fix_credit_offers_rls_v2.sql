-- Correção das políticas RLS para tabela credit_offers - Versão 2
...
COMMENT ON TABLE credit_offers IS 'Tabela de ofertas de crédito - RLS v2 corrigido para account_type em ' || NOW();