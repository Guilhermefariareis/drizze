...
INSERT INTO public.services (clinic_id, name, description, price, duration_minutes) 
SELECT 
  c.id as clinic_id,
  s.service_name,
...
CROSS JOIN (
  VALUES 
    ('Consulta Inicial', 'Avaliação completa e plano de tratamento', 150.00, 60),
    ('Limpeza Dental', 'Profilaxia e remoção de tártaro', 120.00, 45),
    ('Obturação', 'Restauração de cáries', 180.00, 90),
    ('Clareamento Dental', 'Clareamento profissional em consultório', 450.00, 90),
    ('Extração', 'Extração de dente simples', 200.00, 30)
) as s(service_name, service_description, price, duration)
