-- Correção das políticas RLS para tabela credit_offers
...
COMMENT ON TABLE credit_offers IS 'Tabela de ofertas de crédito - RLS corrigido para permitir admin inserir ofertas em ' || NOW();