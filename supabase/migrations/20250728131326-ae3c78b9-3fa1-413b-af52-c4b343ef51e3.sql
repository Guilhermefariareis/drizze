...
CREATE TABLE public.clinics (
    ...
    cnpj TEXT UNIQUE,
    razao_social TEXT,
    parcela_mais_id TEXT, -- ID da clínica no Parcela Mais
    phone TEXT,
    email TEXT,
    address_cep TEXT,
    address_uf TEXT,
...
CREATE TABLE public.loan_requests (
    ...
    parcela_mais_proposal_id TEXT, -- ID da proposta no Parcela Mais
    parcela_mais_response JSONB, -- Resposta completa da API
