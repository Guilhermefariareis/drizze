...
import { HelpCircle, Phone, Mail, MessageSquare, Clock, Shield } from 'lucide-react';
...
export default function SacModal() {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <>
      {/* Botão flutuante fixo */}
      <div className="fixed bottom-32 right-6 sm:bottom-32 z-50">
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="mt-6 p-4 bg-muted/30 rounded-lg">
              <div className="flex flex-wrap gap-2 justify-center mb-3">
                <Badge variant="outline">Atendimento Especializado</Badge>
                <Badge variant="outline">Suporte Técnico</Badge>
                <Badge variant="outline">Mediação de Conflitos</Badge>
                <Badge variant="outline">Orientação Financeira</Badge>
              </div>
