  ...
  return (
    <div className="flex h-screen bg-[#0F0F23] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        {/* Navbar removida ou substituída por header simples */}
        {/* <Navbar /> */}
          ...
          <div className="container mx-auto p-6 space-y-6">
            <div className="w-full max-w-none space-y-6">
              <div className="flex flex-col gap-2 mb-6">
                <h1 className="text-3xl font-black text-white tracking-tight">Horários e Bloqueios</h1>
                <p className="text-muted-foreground">Gerencie o funcionamento da sua clínica</p>
              </div>

              <Tabs defaultValue="funcionamento" className="w-full">
                <TabsList className="grid w-full max-w-none grid-cols-2 bg-white/5 border border-white/10 p-1 rounded-2xl">
                  <TabsTrigger
                    value="funcionamento"
                    className="flex items-center gap-2 data-[state=active]:bg-primary data-[state=active]:text-white rounded-xl transition-all"
                  >
                ...
                <TabsContent value="funcionamento" className="w-full space-y-6 mt-6">
                  <Card className="w-full glass-effect border-none">
                    <CardHeader>
                      <CardTitle className="text-white">Adicionar Horário de Funcionamento</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                          <Label htmlFor="dia-semana" className="text-gray-300">Dia da Semana</Label>
                          <Select
                          ...
                          >
                            ...
                            <SelectContent className="bg-[#1a1a2e] border-white/10 text-white">
                              {diasSemana.map((dia) => (
                                <SelectItem key={dia.value} value={dia.value.toString()} className="focus:bg-white/10 focus:text-white">
                                  {dia.label}
                                </SelectItem>
                              ))}
                            </SelectContent>
                        ...
                        <div>
                          <Label htmlFor="hora-inicio" className="text-gray-300">Hora Início</Label>
                          <Input
                            id="hora-inicio"
                            type="time"
                        ...
                        <div>
                          <Label htmlFor="hora-fim" className="text-gray-300">Hora Fim</Label>
                          <Input
                            id="hora-fim"
                            type="time"
                        ...
                        <div className="flex items-end">
                          <Button onClick={handleSalvarHorario} className="w-full bg-primary hover:bg-primary-hover shadow-glow shadow-primary/20">
                      ...
                      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor="intervalo-inicio" className="text-gray-300">Intervalo Início (Opcional)</Label>
                          <Input
                            id="intervalo-inicio"
                            type="time"
                        ...
                        <div>
                          <Label htmlFor="intervalo-fim" className="text-gray-300">Intervalo Fim (Opcional)</Label>
                          <Input
                            id="intervalo-fim"
                            type="time"
                  ...
                  <Card className="w-full glass-effect border-none">
                    <CardHeader>
                      <CardTitle className="text-white">Horários Configurados</CardTitle>
                    </CardHeader>
                    <CardContent>
                      {!horariosFuncionamento || horariosFuncionamento.length === 0 ? (
                        ...
                        <div className="w-full space-y-3">
                          {horariosFuncionamento?.map((horario) => (
                            <div key={horario.id} className="flex items-center justify-between p-4 border border-white/5 rounded-xl bg-white/5 hover:bg-white/10 transition-all">
                              ...
                              <Button
                                ...
                                className="border-white/10 text-gray-400 hover:text-red-400 hover:bg-red-500/10 hover:border-red-500/20"
                              >
                ...
                <TabsContent value="bloqueios" className="w-full space-y-6 mt-6">
                  <Card className="w-full glass-effect border-none">
                    <CardHeader>
                      <CardTitle className="text-white">Criar Bloqueio de Horário</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                          <Label htmlFor="data-bloqueio" className="text-gray-300">Data</Label>
                          <Input
                            id="data-bloqueio"
                            type="date"
                        ...
                        <div>
                          <Label htmlFor="hora-inicio-bloqueio" className="text-gray-300">Hora Início</Label>
                          <Input
                        ...
                        <div>
                          <Label htmlFor="hora-fim-bloqueio" className="text-gray-300">Hora Fim</Label>
                          <Input
                        ...
                        <div className="flex items-end">
                          <Button onClick={handleSalvarBloqueio} className="w-full bg-rose-500 hover:bg-rose-600 shadow-glow shadow-rose-500/20 text-white border-0">
                            <Plus className="h-4 w-4 mr-2" />
                            Criar Bloqueio
                          </Button>
                        </div>
                      ...
                      <div>
                        <Label htmlFor="motivo-bloqueio" className="text-gray-300">Motivo (Opcional)</Label>
                        <Input
                          id="motivo-bloqueio"
                  ...
                  <Card className="w-full glass-effect border-none">
                    <CardHeader>
                      <CardTitle className="text-white">Bloqueios Ativos</CardTitle>
                    </CardHeader>
                    <CardContent>
                      {!bloqueiosHorario || bloqueiosHorario.length === 0 ? (
                        ...
                        <div className="w-full space-y-3">
                          {bloqueiosHorario?.map((bloqueio) => (
                            <div key={bloqueio.id} className="flex items-center justify-between p-4 border border-white/5 rounded-xl bg-white/5 hover:bg-white/10 transition-all">
                              <div className="flex items-center gap-4">
                                <Badge variant="destructive" className="bg-rose-500/10 text-rose-500 border-rose-500/20 hover:bg-rose-500/20">
